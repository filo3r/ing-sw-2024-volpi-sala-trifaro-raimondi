...
class CardStarterTest {
    ...
    void setUp() {
        ...
        back = new BackSide(Kingdom.NULL, Value.INSECT, Value.ANIMAL, Value.PLANT, Value.FUNGI,center);
    ...
    @Test
    void setBackStarter() {
        BackSide newBack = new BackSide(Kingdom.NULL,Value.EMPTY,Value.FUNGI,Value.PLANT,Value.ANIMAL,center);
        BackSide oldBack = cardStarter.getBackStarter();
