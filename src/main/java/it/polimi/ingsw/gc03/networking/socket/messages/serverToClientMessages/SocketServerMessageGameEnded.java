...
/**
 * This class is used to send a message from the server to the client to inform that the game has ended.
 */
public class SocketServerMessageGameEnded extends SocketServerGenericMessage {
     ...
     */
    public SocketServerMessageGameEnded(GameModel gameModel) {
    ...
    public void execute(GameListener gameListener) throws IOException, InterruptedException {
        gameListener.gameEnded(this.gameModel);
    }
